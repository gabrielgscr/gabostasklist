...
class ProfileScreen extends StatelessWidget {
            ...
            return ListView(
              ...
              children: [
                ...
                ListTile(
                  ...
                  subtitle: Text(person.email!), // Asegúrate de que tu clase Person tiene un campo de correo electrónico.
                  leading: const Icon(Icons.email),
                ),
                ListTile(
                  title: const Text('Fecha de creación'),
                  subtitle: Text('${person.createdDate!}'), // Asegúrate de que tu clase Person tiene un campo de fecha de creación.
                   ...
                   children: [
                    SizedBox(
                      ...
                      child: ClipRRect(
                          ...
                          child: const Image(image: AssetImage('assets/astronauta.png')
                        )
                      ),
                    ),
                    Positioned(
                      ...
                      child: SizedBox(
                        ...
                        child: TextButton(
                          onPressed: () {
                            showSnackbar('Pronto podrás cambiar tu foto de perfil');
                          },
  ...
  Widget _getAutoLoginSwitchTile(){
    ...
    return Obx(() => SwitchListTile(
      ...
      subtitle: const Text('Inicia sesión automáticamente al abrir la aplicación'),
      onChanged: (value){
        controller.remember.value = value;
        controller.setRemember(value);
      },
