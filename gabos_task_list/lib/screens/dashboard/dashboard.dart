...
class Dashboard extends StatelessWidget {
  ...
  Widget _displayTasks(
    Future<List<Task>> Function(int) getTasks,
    void Function() swapFunction,
    bool isExpanded,
    String title, {
    String? noDataTitle,
      ...
      child: Container(
        ...
        child: NotesContainer(
          child: Center(
            child: Text(
              'Tu trabajo cercano',
              style: TextStyle(fontSize: 20, color: strongBlue),
            ),
          ),
        ),
      ),
